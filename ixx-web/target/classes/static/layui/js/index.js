...
function lockPage() {
    layer.open({
        ...
        '<div class="admin-header-lock-img"><img src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1548209173&di=a601b32b162e9f0d58d7db9f74464702&src=http://d.hiphotos.baidu.com/zhidao/pic/item/b17eca8065380cd76216f8bda644ad3459828152.jpg"/></div>'+
        '<div class="admin-header-lock-name" id="lockUserName">@管理后台</div>'+
        '<div class="input_btn">'+
...
function createMenu(url) {
    ...
    $.getJSON(url, function (r) {
        ...
        //显示菜单
        setMenu(r.data);
    }).error(function(r) { redirectPage(r.responseJSON.code) })
    ;
}
//显示菜单
